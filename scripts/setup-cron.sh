...
*/30 * * * * cd $PROJECT_DIR && $NODE_PATH $SCRIPTS_DIR/collect-activity.js >> $PROJECT_DIR/logs/cron/collect.log 2>&1

# Generate daily summary at 10 PM
0 22 * * * cd $PROJECT_DIR && $NODE_PATH $SCRIPTS_DIR/generate-summary.js >> $PROJECT_DIR/logs/cron/summary.log 2>&1
"
